...
log_file_path = os.path.join(log_dir, 'training_logs_ISIC_NOLSA.txt')
...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs, patience=10):
    ...
    if best_model_wts is not None:
        ...
        torch.save(best_model_wts, os.path.join(model_dir, 'noLSA_modelisc.pth'))
...
evaluate_and_plot(
    model_path=os.path.join(model_dir, 'noLSA_modelisc.pth'),
